...
public class ContactsOnlineArrayAdapter extends ArrayAdapter<User> implements Filterable, SectionIndexer {
	    ...
	    public ContactsOnlineArrayAdapter(Activity context, List<User> list) {
	    ...
	    public View getView(int position, View convertView, ViewGroup parent) {
	    	...
	    	if (convertView == null) {
	            ...
	            view = inflator.inflate(R.layout.friend_list_item, null, false);	          
